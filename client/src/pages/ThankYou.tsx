    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-primary/5 to-background flex items-center justify-center px-4 py-20">
      ...
      <div className="max-w-2xl w-full">
        <Card className="p-12 text-center bg-card/90 backdrop-blur shadow-2xl border-2 border-primary/20">
          ...
          <h1 className="text-5xl lg:text-6xl font-black mb-6" data-testid="text-thank-you-title">
            You're All Set!
          </h1>

          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Thank you for choosing Rocket Payments. Our team will be in touch within the next hour to confirm your details and get you started.
          </p>
          ...
          <div className="bg-primary/10 rounded-2xl p-6 mb-8">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold">We'll call you shortly</p>
                  <p className="text-sm text-muted-foreground">A member of our team will verify your business details</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-bold">Quick approval process</p>
                  <p className="text-sm text-muted-foreground">Most businesses are approved within 24 hours</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-bold">Terminal delivered</p>
                  <p className="text-sm text-muted-foreground">Your card machine arrives within 48 hours of approval</p>
                </div>
              </div>
            </div>
          </div>
